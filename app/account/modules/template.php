                            ...
                            if( strlen( $_POST['pswd'] ) >= 10 ) {
                                ...
                                if( !empty( $_POST['pswd'] ) || !empty( $_POST['pret'] ) ) {
                                    ...
                                    if( $_POST['pswd'] == $_POST['pret'] ) {
                                        ...
                                        //set type
                                        $type = ($user == 'admin') ? 'admin' : '{PAGE}';
                                        //check if make page
                                        if( !is_file( $sess_file ) ){
                                            $session = $user_session;
                                            $session['{PAGE}']['email'] = $email;
                                            $session['{PAGE}']['name'] = $user;
                                            $session['{PAGE}']['display'] = $name;
...
if( isset( $_GET['{PAGE}'] ) ) {
    ...
    if( !empty( $_GET['{PAGE}'] ) ) {
        ...
        if( !empty( $_GET['type'] ) ) {
            ...
            $json = array();
            //set save
            $save = array('{PAGE}' => $game, 'type' => $type, 'service' => $service );
            //check directory
            if( !is_dir( $lot_ddir ) ) {
                $lot_ddir = $lot_dpdr;
            }
...
<div class="box box-{PAGE}">
    <div class="box-header">
        ...
        <div class="block">
            {SECTION_1}
            <section class="bg-{COLOR_1}" id="{PAGE}_1">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading">{TITLE_1}</h2>
                            <hr class="primary">
                        </div>
                    </div>
                </div>
            ...
            {SECTION_2}
            <section class="bg-{COLOR_2}" id="{PAGE}_2">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading">{TITLE_2}</h2>
                            <hr class="primary">
                        </div>
                    </div>
                </div>
            ...
            {SECTION_3}
            <section class="bg-{COLOR_3}" id="{PAGE}_3">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading">{TITLE_3}</h2>
                            <hr class="primary">
                        </div>
                    </div>
                </div>
            ...
            {SECTION_4}
            <section class="bg-{COLOR_4}" id="{PAGE}_4">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading">{TITLE_4}</h2>
                            <hr class="primary">
                        </div>
                    </div>
                </div>
            ...
            {SECTION_5}
            <section class="bg-{COLOR_5}" id="{PAGE}_5">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading">{TITLE_5}</h2>
                            <hr class="primary">
                        </div>
                    </div>
                </div>
            ...
            {SECTION_6}
            <section class="bg-{COLOR_6}" id="{PAGE}_6">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading">{TITLE_6}</h2>
                            <hr class="primary">
                        </div>
                    </div>
                </div>
            ...
            {SECTION_7}
            <section class="bg-{COLOR_7}" id="{PAGE}_7">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 text-center">
                            <h2 class="section-heading">{TITLE_7}</h2>
                            <hr class="primary">
                        </div>
                    </div>
                </div>
